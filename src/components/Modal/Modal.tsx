...
return(
  ...
  className=" bg-white p-5 shadow shado-md rounded-[15px]  text-gray-700">
    ...
    <h1 className="pt-2 pb-2 text-gray-700 "><strong className=" flex  gap-2 justify-center items-center">  <User/>Login</strong></h1>
     
        <div className="size-7 text-white flex items-center justify-center bg-red-500 rounded-full cursor-pointer active:scale-101" onClick={()=>{setModal(false)}}>X</div>
  ...
  <Form.PrimaryInput
    ...
    />
    <Form.PrimaryButton disabled={isPending} className="w-full p-2 bg-purple-600 text-white mt-5 rounded-[15px] "  type="submit" text={"Entrar"}/>
</Form.Root>
    </div>
    )
}